...
VALUES
(1, 1, 1, 'Limpiador multiusos', 'Elimina la suciedad y desinfecta.', 'Limpieza', 'Disponible', 100, '2023-05-10', 'Proveedor X', 'src/main/resources/com/example/proyectofinaldb/assets/img/articulos/limpiador-multiusos.PNG', 9911911280000, 30),
(2, 3, 2, 'Medicamento A', 'Alivia dolores leves.', 'Medicina', 'Agotado', 0, '2023-07-25', 'Farmacia Y', 'src/main/resources/com/example/proyectofinaldb/assets/img/articulos/paracetamol.PNG', 100192822333, 50),
